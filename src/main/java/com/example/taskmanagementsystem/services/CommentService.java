...
public class CommentService {
     ...
     * @param username имя пользователя, отправившего запрос на создание записи комментария
     *
     ...
     * @param username имя пользователя, отправившего запрос на обновление записи комментария
     *
     * @return  объект описания результата обращения к базе данных комментариев
     */
     ...
     * @param createDate   момент времени публикации комментария
     * @param username имя пользователя, отправившего запрос на удаление записи комментария
     *
     */
     ...
     * @param username имя пользователя, зарегистрировавшего комментарии к задаче.
     *
